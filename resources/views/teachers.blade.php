...
<div class="container">
    ...
    <h4 align="center">
        <a href="{{ route('teachers.home') }}" class="btn btn-warning">Back</a>
    </h4>
</div>
@else
<div class="container">
    <h1 align="center" class="mb-3">Teachers List</h1>
    <table class="table table-bordered data-table">
        <thead>
            <tr>
                <th>No</th>
        ...
        <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('teachers.index', ['id' => $user->id] ) }}" class="btn btn-info btn-sm">Edit</a>
                        <form  action="/profesores/{{$user->id}}" method="post">
                                @csrf
                                @method('DELETE')
...
<div class="container">
    <h2 align="center" class="mb-3">Create new Teacher</h2>  
...
<script type="text/javascript">
    ...
    $('.update').editable({
           url: "{{ route('teachers.change',  ['id' => @$user->id] ) }}",
           type: 'text',
           pk: 1,
           title: 'Enter name',
           ajaxOptions: {
    ...
    $(document).ready(function(){      
      var postURL = "<?php echo url('profesores'); ?>";
      var i=1;  
